...
import '../../data/repositories/random_users_repository_impl.dart';
import '../../domain/entities/random_users_entiry.dart';
import '../../domain/usecases/random_users_usecase.dart';
...
class _HomePageState extends State<HomePage> {
  RandomUsersUseCase randomUsersUseCase = RandomUsersUseCase(RandomUsersRepositoryImpl());
