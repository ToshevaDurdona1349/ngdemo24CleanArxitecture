...
RandomUsersListModel randomUsersResFromJson(String str) => RandomUsersListModel.fromJson(json.decode(str));

String randomUsersResToJson(RandomUsersListModel data) => json.encode(data.toJson());

class RandomUsersListModel extends RandomUsersEntity {
  RandomUsersListModel({required super.results, required super.info});

  factory RandomUsersListModel.fromJson(Map<String, dynamic> json) => RandomUsersListModel(
    results: List<RandomUserModel>.from(json["results"].map((x) => RandomUserModel.fromJson(x))),
...
class LocationModel extends LocationEntity {
  LocationModel({required super.street,
    required super.city, required super.state, required super.country, required super.postcode, required super.coordinates, required super.timezone});
...
class LoginModel extends LoginEntity{
  LoginModel({required super.uuid, required super.username, required super.password, required super.salt, required super.md5, required super.sha1, required super.sha256});
